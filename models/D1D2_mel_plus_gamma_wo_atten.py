...
def train_model(model, criterion, optimizer, train_loader, val_loader_1=None, val_loader_2=None, num_epochs=40):
    ...
    for epoch in range(num_epochs):
        ...
        if f1_sum > best_f1_sum:
            ...
            torch.save(best_model_wts, "multi_branch_cnn_g_m_wo_train1_d")
    ...
    if best_model_wts is not None:
        ...
        print(f"Training finished. Best model saved as 'multi_branch_cnn_g_m_wo_train1_d' with F1_sum={best_f1_sum:.4f}")
region_paths = {
