...
def train_model(model, criterion, optimizer, train_loader, val_loader_1=None, val_loader_2=None, num_epochs=40):
    ...
    if best_model_wts is not None:
        ...
        print(f"Training finished. Best model saved as 'multi_branch_cnn_m_wi_train1_d.pth' with F1_sum={best_f1_sum:.4f}")
...
if __name__ == '__main__':
    ...
    best_model_path = "multi_branch_cnn_m_wi_train1_d.pth"
