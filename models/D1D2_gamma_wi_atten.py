...
class MultiBranchCNN_G_WI(nn.Module):
    def __init__(self, num_classes):
        super(MultiBranchCNN_G_WI, self).__init__()
...
def load_data(region_paths, bird_classes):
    ...
    train_dataset = datasets['region3']
    test_dataset_region2 = datasets['region1']
...
def train_model(model, criterion, optimizer, train_loader, val_loader_1=None, val_loader_2=None, num_epochs=40):
    ...
    for epoch in range(num_epochs):
        ...
        if f1_sum > best_f1_sum:
            ...
            torch.save(best_model_wts, "multi_branch_cnn_g_wi_train1_d.pth")
    ...
    if best_model_wts is not None:
        ...
        print(f"Training finished. Best model saved as 'multi_branch_cnn_g_wi_train1_d.pth' with F1_sum={best_f1_sum:.4f}")
...
if __name__ == '__main__':
    ...
    best_model_path = "multi_branch_cnn_g_wi_train1_d.pth"
